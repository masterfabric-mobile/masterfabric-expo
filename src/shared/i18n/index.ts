...
const directTranslations: Record<string, Record<string, string>> = {
  en: {
    ...
    "Started creating a new project": "Started creating a new project",
  ...
  tr: {
    ...
    "Started creating a new project": "Yeni proje oluşturulmaya başlandı",
...
const titleTranslationMappings: Record<string, Record<string, string>> = {
  en: {
    ...
    "New Project": "home.actions.newProject.title",
  ...
  tr: {
    ...
    "Yeni Proje": "home.actions.newProject.title",
...
const activityDescriptionMappings: Record<string, Record<string, string>> = {
  en: {
    ...
    "home.activity.newProject": "Started creating a new project",
  ...
  tr: {
    ...
    "home.activity.newProject": "Yeni proje oluşturulmaya başlandı",
